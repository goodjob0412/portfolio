...
//         console.log("a_bang:" +e_bang)

//         // 들어오는판
//         $('.preview_menu_in').eq(e_bang).css({
//             left: g_pos
//         }).animate({
//             left: 0
//         }, timer);
...
//         // 나가는판
//         $('.preview_menu_in').eq(f_bang).animate({
//             left: h_pos
//         }, timer);
...
//         //클릭시 숫자바뀌기
//         let indi_number = (c_bang + 1)%count==0?count:(c_bang + 1)%count
//         $('.slide_count').text(indi_number)
//     }
