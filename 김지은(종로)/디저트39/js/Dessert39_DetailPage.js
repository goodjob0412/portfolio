$(document).ready(function(){
    ...
    // for(let i=0; i < ITEM_LIST[cate_no][sec_no].length; i++) {
        ...
        $('#btn_item_prev').attr('href', 'DetailPage.html?cate_no='+cate_no+'&sec_no='+sec_no+'&item_no='+(item_no-1<1?item_i:item_no-1))
        $('#btn_item_next').attr('href', 'DetailPage.html?cate_no='+cate_no+'&sec_no='+sec_no+'&item_no='+(item_no+1>item_i?1:item_no+1))
