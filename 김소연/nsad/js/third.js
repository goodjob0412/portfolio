$(document).ready(function(){
    ...
    let op_close = document.getElementsByClassName('op_close');
    let tmp_opt_no = document.getElementsByClassName('from_opt_index');
    ...
    // 스크롤
    let main_h = document.getElementsByTagName('main')[0].clientHeight;
    const detail = document.getElementById('detail').clientWidth;
    ...
    function menu_fixed(){
        if(s_top >= d_menu_o_top){
            ...
            //     menu_in[i].style.padding = '1% 0'
            // }
        }
        else{
            d_menu.style.position = 'static';
            // for(let i=0; i<menu_in.length; i++){
            //     menu_in[i].style.padding = '3% 0'
            // }
        }
    }
