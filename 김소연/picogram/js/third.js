$(document).ready(function(){
    ...
    // sec[0].addEventListener("mousewheel", MouseWheelHandler, false);
    // sec[0].addEventListener("DOMMouseScroll", MouseWheelHandler, false);
    ...
    // sec[0].addEventListener('mousewheel DOMMouseScroll' , function(e){
        // console.log("죠기")
        ...
        if(index != -1){
            if(sec[index].offsetLeft == o_left[index]){
                if(index == 0 || index == 4){
                    ...
                    logo.style.background = 'url(img/svg/logo_white.svg) no-repeat center / contain';
                }
                else{
