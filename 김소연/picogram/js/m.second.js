$(document).ready(function(){
    ...
    prev.addEventListener('click', function(){
        prev_chk()
        // btn_prev.setAttribute('d', 'M 40 10 Q 15 50 40 100')
        // setTimeout(function(){
        //     btn_prev.setAttribute('d', 'M 40 10 Q 40 50 40 100')
        // 50 }, 500)
    });

    next.addEventListener('click', function(){
        next_chk()
        // btn_next.setAttribute('d', 'M 10 10 Q 35 50 10 100')
        // setTimeout(function(){
        //     btn_next.setAttribute('d', 'M 10 10 Q 10 50 10 100')
        // }, 500)
    });
