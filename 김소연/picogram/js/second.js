$(document).ready(function(){
    ...
    const c_box = document.getElementsByClassName('center_box')[0];
    ...
    // let item_circle = item_sec[0].clientWidth;
    let left = 0;
    let interval;
    ...
    function next_chk(){
        ...
        item_sec[item_index % item_count].style.left = (item_wid * (item_count-1))+"px";
    ...
    let m_prev = document.getElementById('prev');
    let m_next = document.getElementById('next');
    let m_img = document.getElementsByClassName('m_img');
    let m_indi = document.getElementsByClassName('m_indi');

    let m_count = m_img.length; 
    let m_index = 0;
    let m_interval;
    ...
    if(!m_chk){
        ...
        // btn_more = document.getElementsByClassName('btn_more');
        // m_img = document.getElementsByClassName('m_img');
        // m_prev = document.getElementById('prev');
        // m_next = document.getElementById('next');
        // m_indi = document.getElementsByClassName('m_indi');

        // for(let i=0; i<m_indi.length; i++){
        //     m_indi[i].addEventListener('click', function(){
        //         let indi_index = $(this).index();
        //         modal_chk(indi_index);
        //     });
        // }
...
// 십자가.addEventListener('click', a);

// function a() {
//     let m_prev = document.getElementById('prev');
//     let m_next = document.getElementById('next');

//     m_prev.addEventListener('click', ttt)
// }
